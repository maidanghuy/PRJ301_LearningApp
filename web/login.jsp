        ...
        <div id="form__login" class="form">
            <div class="auth">
                ...
                <div class="auth__body">
                    <form action="#" method="post">
                        ...
                        <div class="auth__button-group">
                            ...
                            <button type="button" class="auth__button auth__button--register hidden">Đăng
                                Ký</button>
                        </div>
                    </form>
                </div>
                ...
                <div class="auth__footer">
                    <p class="auth__footer-text">Chưa có tài khoản? <a href="#" class="auth__footer-link">Đăng
                            Ký</a></p>
                    <p class="auth__footer-text hidden">Bạn đã có tài khoản? <a href="#"
                                                                                class="auth__footer-link">Đăng Nhập</a></p>

                </div>
                <div style="margin: 0 auto;" class="col-12 col-lg-5 d-flex align-items-center">
                    <div class="d-flex gap-3 flex-column w-100 ">
                        <a href="https://accounts.google.com/o/oauth2/auth?scope=email profile openid&redirect_uri=http://localhost:8080/AppLearningEnglish/login&response_type=code&client_id=531669307007-umgdjhisjepb5nqjhk1rvj5vhhlssnn0.apps.googleusercontent.com&approval_prompt=force" class="btn btn-lg btn-danger">
