...
<html>
  ...
  <body>
    ...
    <% Course course = new Course(); if (request.getAttribute("course") != null)
      ...
      <div class="container-right">
        <div class="main-content">
          ...
          <div class="course">
            <div class="course__banner">
              ...
              <div class="course__info">
                ...
                <p class="course__description"><%=course.getDescription()%></p>
              </div>
            </div>
            ...
            <div class="course__details">
              <h2 class="course__title"><%=course.getDescription()%></h2>
              ...
              <% for (int i = detailsList.length - 3; i < detailsList.length;
              i++) {%>
          ...
          <div class="course_footer_btn">
            ...
            >
            <a href="lesson"
              ><button class="btn course__register-btn">Enroll</button></a
            >
          </div>
        </div>
