<%-- 
    Document   : chatbot
    Created on : Mar 8, 2025, 12:13:28 AM
    Author     : macbookpro
--%>
...
<button id="chatbot-toggler">
    ...
    <span class="material-symbols-rounded">close</span> I
</button>
    ...
    <div class="chat-body">
        <div class="message bot-message">
            ...
            <div class="message-text">
                <p>Hello, I'm a chatbot. <br />How can I help you today?</p>
            </div>
        </div>
        <!-- <div class="message user-message">
            <div class="message-text">
                <p>I'm looking for a restaurant near me.</p>
            </div>
        </div>
